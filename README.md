...
<!-- Quick Nav -->
[🏆 Obtainable](#-obtainable-badges) • [🧪 In Testing](#-badges-in-testing) • [⛔ Unobtainable](#-unobtainable-badges) • [🎚️ Tiers](#️-badge-tiers) • [🎨 Skin Tones](#-achievement-skin-tones) • [📖 Step-by-Step Guide](#-step-by-step-earning-guide) • [🔧 Troubleshooting](#-troubleshooting-guide) • [❓ FAQ](#-faq) • [🙈 Hide Badges](#-how-to-hideshowdisable-badges) • [📊 Progress Tracker](#-personal-progress-tracker)
...
GitHub profile badges (also called **Achievements**) were introduced after the launch of the [Ingenuity Mars Helicopter](https://en.wikipedia.org/wiki/Ingenuity_(helicopter)) in 2021. They appear on your public GitHub profile and showcase your contributions and activities across the platform.
...
|:---:|:---|:---|:---:|
| ![Heart on Your Sleeve](https://github.com/Schweinepriester/github-profile-achievements/blob/main/images/heart-on-your-sleeve-default.png?raw=true) | **Heart On Your Sleeve** | React to anything on GitHub with a ❤️ emoji | `🟢 Very Easy` |
| ![Open Sourcerer](https://github.com/Schweinepriester/github-profile-achievements/blob/main/images/open-sourcerer-default.png?raw=true) | **Open Sourcerer** | Have Pull Requests merged in more than 1 public repository | `🟡 Medium` |
...
| Badge | Name | How to Earn | Difficulty |
|:---:|:---|:---|:---:|
| ![Quickdraw](https://github.com/Schweinepriester/github-profile-achievements/blob/main/images/quickdraw-default.png?raw=true) | **Quickdraw** | Close a Pull Request or Issue within 5 minutes of opening | `🟢 Very Easy` |
| ![Public Sponsor](https://github.com/Schweinepriester/github-profile-achievements/blob/main/images/public-sponsor-default.png?raw=true) | **Public Sponsor** | Sponsor any GitHub user, repository, or organization | `🟢 Very Easy` |
| ![Pull Shark](https://github.com/Schweinepriester/github-profile-achievements/blob/main/images/pull-shark-default.png?raw=true) | **Pull Shark** | Get 2 pull requests merged | `🟡 Medium` |
| ![YOLO](https://github.com/Schweinepriester/github-profile-achievements/blob/main/images/yolo-default.png?raw=true) | **YOLO** | Merge a pull request without a code review | `🟡 Medium` |
| ![Galaxy Brain](https://github.com/Schweinepriester/github-profile-achievements/blob/main/images/galaxy-brain-default.png?raw=true) | **Galaxy Brain** | Get 2 answers accepted in GitHub Discussions (not Community Discussions — see note below) | `🟡 Medium` |
| ![Pair Extraordinaire](https://github.com/Schweinepriester/github-profile-achievements/blob/main/images/pair-extraordinaire-default.png?raw=true) | **Pair Extraordinaire** | Co-author a merged pull request | `🔴 Hard` |
| ![Starstruck](https://github.com/Schweinepriester/github-profile-achievements/blob/main/images/starstruck-default.png?raw=true) | **Starstruck** | Have a repository reach 16 stars | `🔴 Hard` |
...
|:---:|:---|:---|
| ![Arctic Code Vault](https://github.com/Schweinepriester/github-profile-achievements/blob/main/images/arctic-code-vault-contributor-default.png?raw=true) | **Arctic Code Vault Contributor** | Contributing to the [2020 GitHub Archive Program](https://archiveprogram.github.com/) |
| ![Mars 2020](https://github.com/Schweinepriester/github-profile-achievements/blob/main/images/mars-2020-contributor-default.png?raw=true) | **Mars 2020 Contributor** | Contributing to repositories used in the [NASA Mars Mission](https://github.com/readme/nasa-ingenuity-helicopter) |
...
|:---:|:---:|:---:|:---:|
| ![](https://github.com/Schweinepriester/github-profile-achievements/blob/main/images/starstruck-default.png?raw=true) | ![](https://github.com/Schweinepriester/github-profile-achievements/blob/main/images/starstruck-bronze.png?raw=true) | ![](https://github.com/Schweinepriester/github-profile-achievements/blob/main/images/starstruck-silver.png?raw=true) | ![](https://github.com/Schweinepriester/github-profile-achievements/blob/main/images/starstruck-gold.png?raw=true) |
| **16 ⭐** | **128 ⭐** | **512 ⭐** | **4,096 ⭐** |

### 🧠 Galaxy Brain
| Default | 🥉 Bronze | 🥈 Silver | 🥇 Gold |
|:---:|:---:|:---:|:---:|
| ![](https://github.com/Schweinepriester/github-profile-achievements/blob/main/images/galaxy-brain-default.png?raw=true) | ![](https://github.com/Schweinepriester/github-profile-achievements/blob/main/images/galaxy-brain-bronze.png?raw=true) | ![](https://github.com/Schweinepriester/github-profile-achievements/blob/main/images/galaxy-brain-silver.png?raw=true) | ![](https://github.com/Schweinepriester/github-profile-achievements/blob/main/images/galaxy-brain-gold.png?raw=true) |
| **2 answers** | **8 answers** | **16 answers** | **32 answers** |

### 🦈 Pull Shark
| Default | 🥉 Bronze | 🥈 Silver | 🥇 Gold |
|:---:|:---:|:---:|:---:|
| ![](https://github.com/Schweinepriester/github-profile-achievements/blob/main/images/pull-shark-default.png?raw=true) | ![](https://github.com/Schweinepriester/github-profile-achievements/blob/main/images/pull-shark-bronze.png?raw=true) | ![](https://github.com/Schweinepriester/github-profile-achievements/blob/main/images/pull-shark-silver.png?raw=true) | ![](https://github.com/Schweinepriester/github-profile-achievements/blob/main/images/pull-shark-gold.png?raw=true) |
| **2 PRs** | **16 PRs** | **128 PRs** | **1,024 PRs** |

### 👥 Pair Extraordinaire
| Default | 🥉 Bronze | 🥈 Silver | 🥇 Gold |
|:---:|:---:|:---:|:---:|
| ![](https://github.com/Schweinepriester/github-profile-achievements/blob/main/images/pair-extraordinaire-default.png?raw=true) | ![](https://github.com/Schweinepriester/github-profile-achievements/blob/main/images/pair-extraordinaire-bronze.png?raw=true) | ![](https://github.com/Schweinepriester/github-profile-achievements/blob/main/images/pair-extraordinaire-silver.png?raw=true) | ![](https://github.com/Schweinepriester/github-profile-achievements/blob/main/images/pair-extraordinaire-gold.png?raw=true) |
| **1 co-author** | **10 co-authors** | **24 co-authors** | **48 co-authors** |
...
### <img src="https://img.shields.io/badge/-VERY%20EASY-2ea043?style=flat-square"/> 🔫 Quickdraw
...
### <img src="https://img.shields.io/badge/-VERY%20EASY-2ea043?style=flat-square"/> 💖 Public Sponsor
...
### <img src="https://img.shields.io/badge/-MEDIUM-d29922?style=flat-square"/> 🦈 Pull Shark
...
### <img src="https://img.shields.io/badge/-MEDIUM-d29922?style=flat-square"/> 🤪 YOLO
...
### <img src="https://img.shields.io/badge/-MEDIUM-d29922?style=flat-square"/> 🧠 Galaxy Brain
...
> 🚨 **Important 2024 Update:** You can NO longer earn this badge via the main GitHub Community Discussions forum (`github.com/orgs/community/discussions`). GitHub disabled badge awarding there in February 2024 to combat spam. Instead, find repos with Discussions enabled using the Explore feature.
...
### <img src="https://img.shields.io/badge/-HARD-da3633?style=flat-square"/> 👥 Pair Extraordinaire
...
> 🔑 The `Co-authored-by:` trailer must be in the exact format shown above.

> 💡 **Pro Tip:** You can add the `Co-authored-by:` line manually in any Git client or even via the GitHub web UI when editing the commit message. GitHub Desktop just makes it easiest.

---

### <img src="https://img.shields.io/badge/-HARD-da3633?style=flat-square"/> ⭐ Starstruck
...
| Tier | Label | Color | Hex Code |
|:---:|:---:|:---:|:---:|
| 🥉 Bronze | `x2` | ![](https://img.shields.io/badge/-%23F9BFA7-F9BFA7?style=flat-square) | `#F9BFA7` |
| 🥈 Silver | `x3` | ![](https://img.shields.io/badge/-%23E1E4E4-E1E4E4?style=flat-square) | `#E1E4E4` |
| 🥇 Gold | `x4` | ![](https://img.shields.io/badge/-%23FAE57E-FAE57E?style=flat-square) | `#FAE57E` |

</div>

---

## 🙈 How to Hide/Show/Disable Badges
...
1. Click on the **Achievements** section on your profile
2. Click on any badge you want to hide
...
### ⏳ Badge Not Appearing After Completing Steps

**Reason 1 — Processing Delay**
GitHub achievements can take up to **24–48 hours** to appear after the qualifying event. Wait a full day, then check again in a private/incognito browser window to rule out cache issues.

**Reason 2 — Private Repository**
Badges only count activity in **public repositories** by default.
...
**Reason 3 — Forked Repository**
Work done only in a **fork** doesn't count. Pull requests or issues created inside a fork won't trigger achievements unless you open a PR to the parent repository and it gets merged.

**Reason 4 — Organization Repository (Starstruck)**
For the Starstruck badge specifically, the repository must be **personally owned by you**, not by an organization. Stars on org repos don't count.

**Reason 5 — Closed vs. Merged PR (Pull Shark / YOLO)**
For Pull Shark, only **merged** pull requests count. A PR that is closed without merging is ignored entirely.

### 🔄 Quick Fix for Stuck Badges
A common trick that many users have confirmed works:
1. Go to your Achievements tab on your profile
2. Find the stuck badge
3. **Hide** it (toggle off)
4. Wait a few seconds
5. **Unhide** it (toggle back on)

This forces GitHub to re-sync the badge status and often fixes display issues.

### 📬 Still Stuck?
Contact [GitHub Support](https://support.github.com) — they can manually trigger a badge refresh for your account.
...
> Yes! Both the author of the commit and the person listed as `Co-authored-by` earn the badge when the PR is merged.
...
| ⭐ Starstruck | ⬜ Not earned | Default / 🥉 / 🥈 / 🥇 |
```

> Change `⬜ Not earned` to `✅ Earned` as you collect badges!

---

## ⚡ Quick Reference: Easiest to Hardest
...
| 4️⃣ | 🤪 **YOLO** | ~20 minutes | ⚠️ Usually needs 2 accounts | Can solo if no branch protection |
| 5️⃣ | 🧠 **Galaxy Brain** | Days–Weeks | ✅ Yes | Use public repo Discussions, not Community |
| 6️⃣ | 👥 **Pair Extraordinaire** | ~30 minutes | ⚠️ Needs a collaborator | Both earn the badge |
| 7️⃣ | ⭐ **Starstruck** | Weeks–Months | ⚠️ Needs community | Repo must be personally owned |
...
> Tracking important changes to GitHub's badge system over time.
...
2. Create a branch: `git checkout -b fix/my-update`
3. Commit your changes: `git commit -m "Update badge info"`
4. Push to the branch: `git push origin fix/my-update`
